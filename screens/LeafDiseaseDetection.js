      ...
      {selectedImage ? (
        <View style={styles.imageContainer}>
          ...
          <Text style={styles.resultText}>
            Image uploaded successfully. Analyzing for disease...
          </Text>
        </View>
      ) : (
        <>
...
//       const prediction = await getPrediction(uri); // Get prediction from the model
...
//     // Replace with your server URL or model endpoint
...
//       return result.prediction; // Assuming your server returns { prediction: 'diseased' }
//     } catch (error) {
//       console.error(error);
...
//       ) : (
//         <>
//           <Text style={styles.title}>Leaf Disease Detection Details</Text>
//           <Text style={styles.description}>
//             Click an image of a Leaf to find whether it is diseased or not
//           </Text>
